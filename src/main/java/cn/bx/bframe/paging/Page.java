...
public class Page<E> extends ArrayList<E>{
    ...
    private boolean count;//包含count查询
    private Boolean countSignal;//count信号，3种情况，null的时候执行默认BoundSql,true的时候执行count，false执行分页
    ...
    private int datatableDraw;//DataTable控件服务端返回标记
    public Page() {
        super();
    }
     ...
     * DataTable返回标记
     *
     * @return datatableDraw
     */
    public int getDatatableDraw() {
		return datatableDraw;
	}
    /**
     * 设置DataTable返回标记
     ...
     * @return
     */
	public void setDatatableDraw(int datatableDraw) {
