...
import cn.bx.bframe.paging.parser.impl.AbstractParser;
import cn.bx.bframe.paging.sqlsource.PageDynamicSqlSource;
import cn.bx.bframe.paging.sqlsource.PageProviderSqlSource;
import cn.bx.bframe.paging.sqlsource.PageRawSqlSource;
import cn.bx.bframe.paging.sqlsource.PageSqlSource;
import cn.bx.bframe.paging.sqlsource.PageStaticSqlSource;
...
public class SqlUtil implements Constant {
    ...
    public static <T> Page<T> getPageFromObject(Object params) {
        ...
        //DataTable返回标记  add by bcm
        Object datatableDraw = getParamValue(paramsObject, "tableDraw", false);
        if (datatableDraw != null) {
            page.setDatatableDraw(Integer.parseInt(datatableDraw.toString()));
        }
        return page;
    }
    ...
    public void setParams(String params) {
        ...
        PARAMS.put("tableDraw", "tableDraw");
